 ...
 *     - `options.vdir.www` {String} www directory containing app HTML5 files. (default: 'www')
 *     - `options.watches` {Array} File name patterns to watch that trigger a reload (default: www + '/**')
 */
...
module.exports = function(options) {
    ...
    var lastModified = Date.now(),
        www = path.normalize((options.vdir && options.vdir.www) || 'www'),
        watches = options.watches || [ www + '/**/*' ];
