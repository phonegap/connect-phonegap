        ...
        if (req.url.indexOf('/__api__/appzip') === 0) {
            ...
            if (req.method === 'HEAD') {
                ...
                InjectHTML.prototype._transform = function (chunk, encoding, callback) {
                    ...
                    var cspTag = "<meta http-equiv=\"Content-Security-Policy\" content=\"default-src 'self' data: gap: https://ssl.gstatic.com 'unsafe-eval'; style-src 'self' 'unsafe-inline'; media-src *; script-src 'self' 'unsafe-inline'\">";
