...
module.exports = function(options, callback) {
    ...
    var destination = {};
    destination.appPath = path.join(os.tmpdir(), 'connect-phonegap', options.req.sessionID);
    destination.wwwPath = path.join(destination.appPath, 'www');
    destination.zipPath = path.join(destination.appPath, 'www.zip');
