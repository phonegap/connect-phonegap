...
module.exports.parse = function() {
    ...
    platform = {
        // test against "Chrome" for Android 4.4.2 support
        // browser needs to come first otherwise it will return Android for desktop Chrome
        browser: /Mac OS X/.test(agent) || /Windows/.test(agent),
