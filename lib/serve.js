...
module.exports = function(options) {
    ...
    server.on('listening', function() {
        ...
        ip.address(function(e, address, addresses) {
            ...
            //console.log('here1' + data.addresses);
    ...
    pg.on('browserAdded', function() {
        server.emit.apply(server, [ 'browserAdded' ]);
    });

    pg.on('deviceConnected', function() {
        server.emit.apply(server, [ 'deviceConnected' ]);
    });
